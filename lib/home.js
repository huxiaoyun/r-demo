...
function renderChart() {
  RechartCore.ChartBuilder({
    ...
    tooltip: true,
    axis: true,
    series: [{ position: ['year', 'gdp'], gemo: 'line', color: '#00c49f' }],
  ...
  RechartCore.ChartBuilder({
    ...
    tooltip: true,
    axis: true,
    series: [{ position: ['year', 'gdp'], gemo: 'bar', color: '#00c49f' }],
  ...
  RechartCore.ChartBuilder({
    ...
    tooltip: true,
    axis: true,
    series: [{ position: ['year', 'gdp'], quickType: 'pie', color: '#00c49f' }],
  ...
  RechartCore.ChartBuilder({
    ...
    tooltip: true,
    axis: true,
    series: [{ position: ['year', 'gdp'], gemo: 'area', color: '#00c49f' }],
